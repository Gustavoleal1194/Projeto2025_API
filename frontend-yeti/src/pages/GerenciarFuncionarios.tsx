                                        ...
                                        <td className="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                            <div className="flex space-x-2">
                                                ...
                                                <button
                                                    ...
                                                    className={`px-4 py-2 rounded-lg font-semibold transition-all duration-300 transform hover:scale-105 shadow-lg border-2 ${funcionario.ativo
                                                        ? 'bg-yellow-500 hover:bg-yellow-600 text-white border-yellow-600'
                                                        : 'bg-green-500 hover:bg-green-600 text-white border-green-600'
                                                        }`}
                                                >
                                                    {funcionario.ativo ? '⏸️ Desativar' : '▶️ Ativar'}
                                                </button>
                                                <button
                    ...
                    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
                        <div className="bg-white rounded-2xl p-6 w-full max-w-2xl max-h-[90vh] overflow-y-auto">
                            <div className="flex justify-between items-center mb-6">
                                ...
                                <button
                                    onClick={closeModal}
                                    className="text-gray-400 hover:text-gray-600 bg-red-500 hover:bg-red-600 text-white rounded-full w-8 h-8 flex items-center justify-center transition-all duration-200"
                                >
                                    ✕
                                </button>
                            </div>
                            ...
                            <div className="flex justify-end gap-4 mt-8">
                                <button
                                    onClick={closeModal}
                                    className="px-6 py-3 bg-red-500 hover:bg-red-600 text-white rounded-full font-semibold transition-all duration-200 border-2 border-red-500 hover:border-red-600"
                                >
                                    ❌ Cancelar
                                </button>
                                <button
                                    onClick={saveFuncionario}
                                    className="px-6 py-3 bg-green-500 hover:bg-green-600 text-white rounded-full font-semibold transition-all duration-200 border-2 border-green-500 hover:border-green-600"
                                >
                                    {editingFuncionario ? '✏️ Atualizar' : '➕ Criar'}
                                </button>
                            </div>
                        </div>
                    </div>
